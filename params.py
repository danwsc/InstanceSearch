...
def get_params():
    ...
    params['fast_rcnn_path'] = '../Faster-RCNN_TF/'
    # params['net'] = 'data/models/faster_rcnn_models/VGG16_faster_rcnn_final.caffemodel'
    # params['net_proto'] ='data/models/test.prototxt'
    params['network_name'] = 'VGGnet_test'
    params['model'] = '/home/suchun/models/VGGnet_fast_rcnn_iter_70000.ckpt'
    ...
    params['oxford_corrupt_list'] = ['magdalen_000313.jpg',
                                     'oxford_001225.jpg']
